...
public class DoubleSorting {
    ...
    */
   public static int binarySearch(double[] a, int left, int right, double element) {
      if (left >= right) return left;
      int mid = (left + right) / 2;
      return binarySearch(a, element > a[mid] ? mid + 1 : left, element < a[mid] ? mid : right, element);
   }
